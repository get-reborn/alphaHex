...
'''deepNet_player test
model1 = models.load_model('/home/reget/project/AlphaHex/model_0502.h5')
model2 = models.load_model('/home/reget/project/AlphaHex/model0502_1.h5')
player1 = DeepLearningPlayer(model1)
player2 = DeepLearningPlayer(model2)
for j in range(20):
    game = HexGame(11)
    for i in range(64):
        # game.legalBoard()
